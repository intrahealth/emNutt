...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication">
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-flow-run']) &gt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-flow-run': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-flow-run']) &lt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-flow-run': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
