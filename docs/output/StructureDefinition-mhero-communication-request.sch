...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CommunicationRequest">
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-req-flow-starts']) &lt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-req-flow-starts': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-req-broadcast-starts']) &lt;= 1">extension with URL = 'http://mHero.org/fhir/StructureDefinition/mhero-comm-req-broadcast-starts': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
